...
public class SignUpExistedEmail {
	WebDriver driver;
	...
	public void signUpExistedEmail() throws Exception{
		...
		// locate the Text on the calculator by using By.name()
				...
				WebElement error = driver.findElement(By.id("message"));
				String invEmail = error.getText();
				System.out.println("Get text "+invEmail+"");
				
				Assert.assertEquals(invEmail, "Email address is already registered. Please use another email.");
